...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3tertiary_paletteKeyColor: "#D699B6"
        property color m3neutral_paletteKeyColor: "#7A8478"
        property color m3neutral_variant_paletteKeyColor: "#859289"
        property color m3background: "#272E33"
        property color m3onBackground: "#D3C6AA"
        property color m3surface: "#2E383C"
        property color m3surfaceDim: "#1E2326"
        property color m3surfaceBright: "#414B50"
        property color m3surfaceContainerLowest: "#1E2326"
        property color m3surfaceContainerLow: "#272E33"
        property color m3surfaceContainer: "#2E383C"
        property color m3surfaceContainerHigh: "#374145"
        property color m3surfaceContainerHighest: "#414B50"
        property color m3onSurface: "#D3C6AA"
        property color m3surfaceVariant: "#493B40"
        property color m3onSurfaceVariant: "#9DA9A0"
        property color m3inverseSurface: "#D3C6AA"
        property color m3inverseOnSurface: "#272E33"
        property color m3outline: "#859289"
        property color m3outlineVariant: "#495156"
        property color m3shadow: "#000000"
        property color m3scrim: "#000000"
        property color m3surfaceTint: "#A7C080"
        property color m3primary: "#A7C080"
        property color m3onPrimary: "#272E33"
        property color m3primaryContainer: "#3C4841"
        property color m3onPrimaryContainer: "#D3C6AA"
        property color m3inversePrimary: "#3C4841"
        property color m3secondary: "#83C092"
        property color m3onSecondary: "#272E33"
        property color m3secondaryContainer: "#7FBBB3"
        property color m3onSecondaryContainer: "#D3C6AA"
        property color m3tertiary: "#D699B6"
        property color m3onTertiary: "#272E33"
        property color m3tertiaryContainer: "#493B40"
        property color m3onTertiaryContainer: "#D3C6AA"
        property color m3error: "#E67E80"
        property color m3onError: "#272E33"
        property color m3errorContainer: "#4C3743"
        property color m3onErrorContainer: "#D3C6AA"
        property color m3primaryFixed: "#D3C6AA"
        property color m3primaryFixedDim: "#A7C080"
        property color m3onPrimaryFixed: "#272E33"
        property color m3onPrimaryFixedVariant: "#3C4841"
        property color m3secondaryFixed: "#D3C6AA"
        property color m3secondaryFixedDim: "#83C092"
        property color m3onSecondaryFixed: "#272E33"
        property color m3onSecondaryFixedVariant: "#859289"
        property color m3tertiaryFixed: "#D3C6AA"
        property color m3tertiaryFixedDim: "#D699B6"
        property color m3onTertiaryFixed: "#272E33"
        property color m3onTertiaryFixedVariant: "#493B40"
        property color m3success: "#A7C080"
        property color m3onSuccess: "#272E33"
        property color m3successContainer: "#3C4841"
        property color m3onSuccessContainer: "#D3C6AA"
        property color term0: "#7A8478"
        property color term1: "#E67E80"
        property color term2: "#A7C080"
        property color term3: "#DBBC7F"
        property color term4: "#7FBBB3"
        property color term5: "#D699B6"
        property color term6: "#83C092"
        property color term7: "#D3C6AA"
        property color term8: "#7A8478"
        property color term9: "#E67E80"
        property color term10: "#A7C080"
        property color term11: "#DBBC7F"
        property color term12: "#7FBBB3"
        property color term13: "#D699B6"
        property color term14: "#83C092"
        property color term15: "#D3C6AA"
    ...
    font: QtObject {
        property QtObject family: QtObject {
            property string main: "Monofur Nerd Font Mono"
